/*-
 * #%L
 * aiSSEMBLE License::Example::Limited Government Use::Java
 * %%
...
package com.boozallen.aissemble.license;

/**
 * Sample java file for license and copyright application.
 */
public interface ExampleJavaClass {
